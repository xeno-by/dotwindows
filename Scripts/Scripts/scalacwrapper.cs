...
//  public static String classpath = @"%PROJECTS%\Kepler\lib\fjbg.jar;%PROJECTS%\Kepler\build\quick\classes\compiler;%PROJECTS%\Kepler\build\quick\classes\library";
...
//  public static String javaopts = "-Dscala.usejavacp=true -Dscala.timings=true";
  public static String javaopts = "-Dscala.usejavacp=true";
  public static String scalaopts = "-deprecation -unchecked -Xexperimental -language:experimental.macros -Yreify-debug -Yshow-trees-compact -Yshow-trees-stringified -g:vars";
//  public static String scalaopts = "";
