...
public class App {
  public static String miniProfile { get { return File.ReadAllText("%SCRIPTS_HOME%/ant.mini".Expand()); } }
  public static String maxiProfile { get { return File.ReadAllText("%SCRIPTS_HOME%/ant.maxi".Expand()); } }
