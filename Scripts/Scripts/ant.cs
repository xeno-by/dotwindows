...
public class App {
  public static String miniProfile = "-Xss128m -Xms1280m -Xmx1280m -XX:+UseParallelGC -XX:MaxPermSize=512M";
  public static String maxiProfile = "-Xss128m -Xms3072m -Xmx3072m -XX:+UseParallelGC -XX:MaxPermSize=1024M";
